...
namespace Udeytech\Hardik\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_udeytech_hardik_items');
        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $form->setHtmlIdPrefix('item_');
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Item Information')]);
        if ($model->getId()) {
            $fieldset->addField('hardik_id', 'hidden', ['name' => 'hardik_id']);
        }
        $fieldset->addField(
            'title',
            'text',
