...
class Save extends \Udeytech\Hardik\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('udeytech/hardik');
                        ...
                        $imagePath = 'udeytech/hardik'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('udeytech_hardik/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('udeytech_hardik/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('udeytech_hardik/*/new');
                }
                return;
            } catch (\Exception $e) {
